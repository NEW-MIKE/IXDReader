...
public class ListDataSaveUtil {
    ...
    public static void init(Context mContext){
        preferences = mContext.getSharedPreferences(OneItemBook.BOOK_PREF_NAME, Context.MODE_PRIVATE);
    ...
    public <T> List<T> getDataList(String tag) {
        ...
        Gson gson = new Gson();
        datalist = gson.fromJson(strJson, new TypeToken<List<OneItemBook>>() {
        }.getType());
        return datalist;
